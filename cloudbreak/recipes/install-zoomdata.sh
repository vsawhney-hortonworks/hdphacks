...
SERVICES='zoomdata-consul,zoomdata-screenshot-service,zoomdata-query-engine,zoomdata-scheduler,zoomdata-stream-writer,zoomdata-upload-service,zoomdata'
...
# Zoomdata repo
ZOOMDATA_VERSION=${ZOOMDATA_VERSION:-3.1}
ZOOMDATA_REPO_NAME=${ZOOMDATA_REPO_NAME:-zoomdata-${ZOOMDATA_VERSION}}
ZOOMDATA_REPO_URI=${ZOOMDATA_REPO_URI:-https://repo.zoomdata.com}
...
pg_install_redhat () {
    ...
    yum install --enablerepo=pgdg95 -y postgresql95-server >>/tmp/zoomdata-installer.log 2>&1
}
...
baseurl=${ZOOMDATA_REPO_URI}/${ZOOMDATA_VERSION}/yum/redhat/${redhat_release}/x86_64/stable
enabled=1
gpgkey=${ZOOMDATA_REPO_KEY}
gpgcheck=1

[${ZOOMDATA_REPO_NAME}-unstable]
name=Zoomdata ${ZOOMDATA_VERSION} unstable RPMs
baseurl=${ZOOMDATA_REPO_URI}/${ZOOMDATA_VERSION}/yum/redhat/${redhat_release}/x86_64/unstable
enabled=0
gpgkey=${ZOOMDATA_REPO_KEY}
gpgcheck=1
EOF
...
[zoomdata-tools]
name=Zoomdata support tools
baseurl=${ZOOMDATA_REPO_URI}/tools/yum/redhat/${redhat_release}/x86_64/stable
enabled=1
gpgkey=${ZOOMDATA_REPO_KEY}
gpgcheck=1
EOF
